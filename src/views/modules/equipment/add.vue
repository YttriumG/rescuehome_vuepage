<template>
  <div class="mod-menu">
    <el-form :inline="true" :model="dataForm"  ref="dataForm" :rules="dataRules" label-width="150px">
      <el-form-item label="志愿者名称：" prop="equipmentName">
        <el-input v-model="dataForm.equipmentName" placeholder="输入志愿者名称" ></el-input>
      </el-form-item>
      ...
      <el-form-item label="数量：" prop="equipmentNum">
        <el-input v-model="dataForm.equipmentNum" placeholder="输入志愿者数量"></el-input>
      </el-form-item>
    </el-form>
    <el-form :inline="true" :rules="dataRules"  ref="dataForm" :model="dataForm" label-width="150px">
      <el-form-item label="所在区：" prop="district">
        <el-select v-model="dataForm.district"
                   ...
                   placeholder="选择志愿者所在区" style="width:185px">
          <el-option
      ...
      <el-form-item label="选择志愿者位置：" prop="locationName">
    ...
    <el-form label-width="150px" :rules="dataRules"  ref="dataForm" :model="dataForm">
      <el-form-item label="确认志愿者编码：" prop="equipmentId">
    ...
    <div >
      <el-button type="primary"  @click="save()">新增志愿者</el-button>
    </div>
    <!-- 弹窗, 新增 / 修改 -->
    ...
    data () {
      return {
        ...
        dataRules:{
          ...
          belongTypename :[
            {required: true, message: '志愿者所属分类不能为空', trigger: 'change' }
          ],
          equipmentNum :[
            {required: true, message: '志愿者数量不能为空', trigger: 'blur' }
          ],
          district :[
            {required: true, message: '志愿者所属区县不能为空', trigger: 'blur' }
          ],
          locationName :[
            {required: true, message: '志愿者位置不能为空', trigger: 'blur' }
          ],
          equipmentId :[
            {required: true, message: '志愿者编码不能为空', trigger: 'blur' }
          ],
          administrator :[
