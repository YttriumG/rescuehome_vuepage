<template>
  <el-dialog
    ...
    <div style="text-align: left; margin-bottom: 20px">
      <font size="4" color="#17b3a3">志愿者报警处理</font>
    </div>
    ...
    <div style="text-align: left">
      <font size="4" color="#17b3a3">志愿者详细信息</font>
    </div>
    <el-form :inline="true" :model="dataForm"  ref="dataForm"  label-width="150px">
      <el-form-item label="志愿者名称：" >
        <el-input v-model="dataForm.equipmentName" readonly="readonly" placeholder="输入志愿者名称" ></el-input>
      </el-form-item>
